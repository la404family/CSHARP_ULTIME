...
% Fichier : src/P1_11_a.tex
% Sujet   : Chapitre 11 : POO — Héritage et Polymorphisme
% ==============================================================================

\newpage
\section{POO — Héritage et Polymorphisme}
\marginpar{\tiny\color{gray}P1\_11\_a.tex}
...
{
    protected readonly string ParserVersion = "1.0";
...
class Program
{
    static void Main()
    {
        ...
        foreach (var proc in processors)
        {
            ...
            // Alternative historique avec 'as' (nécessite le type nullable '?' sous NRT <Nullable>enable</Nullable>)
