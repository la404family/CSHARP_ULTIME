...
\begin{center}
    ...
    \begin{tabular}{@{}lllp{6cm}@{}}
        ...
        \midrule
        \textbf{PascalCase} & Majuscule à chaque mot & \texttt{CalculerPrixTotal} & Classes, structures, enums, méthodes, propriétés, événements. \\
        ...
        \textbf{PascalCase} & Majuscule à chaque mot & \texttt{NombreMaxEssais} & Constantes (\texttt{const} et \texttt{readonly}). \\
        \bottomrule
    \end{tabular}
\end{center}
