...
\begin{lstlisting}[style=csharpstyle]
// Le bloc using assure la fermeture du fichier système en toutes circonstances
using (StreamReader reader = new StreamReader("C:\\data\\config.json"))
{
    string contenu = reader.ReadToEnd();
    Console.WriteLine(contenu);
} // reader.Dispose() est appelé implicitement et automatiquement ici
\end{lstlisting}
