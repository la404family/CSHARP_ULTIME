...
\begin{center}
    ...
    \begin{tabular}{@{}clp{7cm}@{}}
        ...
        \midrule
        1 & \texttt{()}, \texttt{.}, \texttt{[]} & Parenthèses, accès membre, indexeur \\
        2 & \texttt{!}, \texttt{++}, \texttt{-{}-}, \texttt{(cast)} & Opérateurs unaires, négation, cast \\
        3 & \texttt{*}, \texttt{/}, \texttt{\%} & Multiplication, division, modulo \\
        4 & \texttt{+}, \texttt{-} & Addition, soustraction \\
        5 & \texttt{<}, \texttt{>}, \texttt{<=}, \texttt{>=}, \texttt{is}, \texttt{as} & Comparaison et vérification de type \\
        6 & \texttt{==}, \texttt{!=} & Égalité \\
        7 & \texttt{\&\&} & ET logique \\
        8 & \texttt{||} & OU logique \\
        9 & \texttt{?:} & Ternaire conditionnel \\
        10 & \texttt{=}, \texttt{+=}, \texttt{-=}, etc. & Affectation \\
        \bottomrule
    \end{tabular}
\end{center}
